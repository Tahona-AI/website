...
| `WhyTahona` | `src/components/sections/WhyTahona.astro` | Astro | None |
...
| --- | --- | --- |
| `FadeInView` | `src/components/animations/FadeInView.tsx` | `Services`, `HowWeWork` |
...
| CTA class constants | `src/components/ui/cta-styles.ts` | `Navbar`, `Hero`, `Contact`, `Footer` |
