...
const VALUE_POINTS = [
  "Tecnología que se adapta a tu operativa, no al revés",
  "Sistemas conectados a tus herramientas actuales",
  "Resultados en producción desde las primeras semanas",
  "Partner tecnológico, no proveedor de horas",
] as const;
            ...
            <FadeInView delay={0.15}>
              <div className="aspect-[4/3] w-full overflow-hidden rounded-none border border-gray-200">
                <img
                  ...
                  alt="Sistemas de IA en producción conectados a procesos empresariales"
          ...
          <div className="flex flex-col lg:justify-between">
            <FadeInView delay={0.1}>
              <p className="text-base leading-relaxed text-gray-500 md:text-lg">
                Tahona es una agencia de IA fundada por Daniel Kwapien. Trabajamos con pymes y medianas empresas que ya experimentaron con ChatGPT y necesitan sistemas que funcionen en producción. No vendemos horas ni promesas. Construimos tecnología que se integra con tus sistemas y escala con tu negocio.
              </p>
            </FadeInView>
