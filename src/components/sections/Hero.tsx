...
import { HeroWorkflowAnimation } from "@/components/sections/HeroWorkflowAnimation";
import {
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="relative min-h-[calc(100svh-4rem)] md:min-h-[calc(100svh-5rem)]">
          <div className="relative z-20 grid min-h-[calc(100svh-4rem)] items-center gap-10 px-6 py-12 sm:px-10 md:min-h-[calc(100svh-5rem)] lg:grid-cols-[minmax(0,0.94fr)_minmax(28rem,1.06fr)] lg:gap-8 lg:px-12 lg:py-16 xl:gap-12 xl:px-16">
            <div className="relative">
              <motion.h1
                initial={{ opacity: 0, y: 24 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7, delay: 0.1 }}
                className="max-w-5xl font-heading text-[clamp(2rem,4vw,3.9rem)] font-semibold leading-[1.02] text-gray-900 text-balance lg:max-w-[44rem]"
              >
                {title}
              </motion.h1>
              ...
              <motion.p
                ...
                className="mt-8 max-w-3xl text-[clamp(1rem,1.35vw,1.25rem)] leading-8 text-gray-500 text-pretty lg:max-w-[38rem]"
              >
                {description}
              </motion.p>
